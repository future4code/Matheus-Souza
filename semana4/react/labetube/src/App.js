      ...
      <div className="tela-inteira">
        ...
        <main>
          <nav className="menu-vertical">
            <ul>
              <li className="botoes-meunu-vertical"><img src = {home} className ="icon"/>Início</li>
              <li className="botoes-meunu-vertical"><img src = {trading}  className ="icon"/>Em alta</li>
              <li className="botoes-meunu-vertical"><img src = {subs}  className ="icon"/>Inscrições</li>
              <hr />
              <li className="botoes-meunu-vertical"><img src = {compass}  className ="icon"/>Originais</li>
              <li className="botoes-meunu-vertical"><img src = {historico}  className ="icon"/>Histórico</li>
            </ul>
          </nav>
